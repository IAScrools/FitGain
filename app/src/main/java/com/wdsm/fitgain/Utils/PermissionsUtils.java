...
public class PermissionsUtils {
    ...
    public static void requestGoogleFitPermissions(@NonNull Activity activity,
                                                   @NonNull GoogleSignInAccount account,
                                                   @NonNull FitnessOptions fitnessOptions) {
        GoogleSignIn.requestPermissions(activity, 1, account, fitnessOptions);
    }

    public static boolean checkGoogleFitPermissions(@NonNull GoogleSignInAccount account,
                                                    @NonNull FitnessOptions fitnessOptions) {
